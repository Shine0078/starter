...
- **The API and its domain logic run and are tested.** 388 tests run with no
  database; the full suite is **489 passing** against real PostgreSQL, including
...
- **The Flutter app is verified by static analysis, 62 tests, and real
