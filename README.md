...
- **The API and its domain logic run and are tested.** 410 tests run with no
  database; the full suite is **511 passing** against real PostgreSQL, including
...
- **The Flutter app is verified by static analysis, 69 tests, and real
