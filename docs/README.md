...
[`MISSION1.md`](../MISSION1.md) and [`MISSION2.md`](../MISSION2.md) are the
product briefs. These documents translate them into something buildable.
...
| [17-public-hosting-google-cloud-run.md](17-public-hosting-google-cloud-run.md) | Managed Cloud Run + Neon deployment with no VM maintenance                         |
...
1. `MISSION1.md` and `MISSION2.md` — what we're building and for whom.
