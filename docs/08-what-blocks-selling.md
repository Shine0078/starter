...
| 9.4 | Test counts drift out of date and are then quoted as evidence — older counts were stale until re-measured at 388/489/60 | fixed in `07-session-notes.md`, but the pattern will recur |
