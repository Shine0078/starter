...
```bash
npm install
npm test          # 427 tests, no database needed
npm run test:db   # 529 tests, spins up a real PostgreSQL and tears it down
...
| Check | Result |
|---|---|
| API tests, in-memory | 427 passed |
| API tests, real Postgres | 529 passed |
| `tsc --noEmit`, `npm run build` | clean |
| `flutter analyze`, `flutter test` | clean, 75 passed |
