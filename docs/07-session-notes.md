...
```bash
npm install
npm test          # 304 tests, no database needed
npm run test:db   # 402 tests, spins up a real PostgreSQL and tears it down
...
| Check | Result |
|---|---|
| API tests, in-memory | 304 passed |
| API tests, real Postgres | 402 passed |
