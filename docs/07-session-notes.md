...
```bash
npm install
npm test          # 417 tests, no database needed
npm run test:db   # 518 tests, spins up a real PostgreSQL and tears it down
...
| Check | Result |
|---|---|
| API tests, in-memory | 417 passed |
| API tests, real Postgres | 518 passed |
