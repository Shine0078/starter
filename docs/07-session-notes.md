...
```bash
npm install
npm test          # 423 tests, no database needed
npm run test:db   # 524 tests, spins up a real PostgreSQL and tears it down
...
| Check | Result |
|---|---|
| API tests, in-memory | 423 passed |
| API tests, real Postgres | 524 passed |
